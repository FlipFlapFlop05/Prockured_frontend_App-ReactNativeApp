...
import NewBasket from '../Client/NewBasket';
import ViewSummary from '../Vendor/ViewSummary';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName={'Splash Screen'} screenOptions={{headerShown: false}}>
        ...
        <Stack.Screen name={"New Basket"} component={NewBasket} />
        {/*Vendor Stack*/}
        ...
        <Stack.Screen name={"View Summary"} component={ViewSummary} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
