...
export const tagColors = {
  'All Restaurants': '#FFCFCF',
  'Asian Restaurant': '#FFECB7',
  Cafe: '#FFCFCF',
  'Mall Road': '#BEBFE0',
  'Indian Restaurant': '#FFECB7',
  'Beach Road': '#BEBFE0',
  'Ring Marg': '#BEBFE0',
};
...
export const worksData = [
  {
    id: 1,
    title: 'Find your supplies',
    description: 'Discover top vendors',
    image: AddSupplierImage,
    screen: 'Search Bar',
  },
  {
    id: 2,
    title: 'Explore',
    description: 'Effortless browsing!',
    image: ExploreImage,
  },
  {
    id: 3,
...
export const customers = [
  {
    ...
    pastOrders: [
      {
        PastOrderDate: '25-06-2024',
        MostOrdered: 'Zuccini',
        NumberOfItems: '50',
        TotalValue: '4,375',
      },
      {
        PastOrderDate: '16-06-2024',
        MostOrdered: 'Carrot',
        NumberOfItems: '45',
        TotalValue: '8,375',
      },
      {
        PastOrderDate: '08-06-2024',
        MostOrdered: 'Tomato',
        NumberOfItems: '15',
        TotalValue: '7,375',
      },
  ...
  },
  {
    ...
    pastOrders: [
      {
        PastOrderDate: '01-06-2024',
        MostOrdered: 'Potato',
        NumberOfItems: '45',
        TotalValue: '10,542',
      },
      {
        PastOrderDate: '28-05-2024',
        MostOrdered: 'Tomato',
        NumberOfItems: '15',
        TotalValue: '7,375',
      },
...
export const vendorExistingPresets = [
  {
    ...
    questions: [
      ...
      },
      {
        id: 'q2',
        taglineText:
          'Creamy Delight at a Discount! Enjoy 20% off. Perfect for you next gucamole!',
        date: '12',
        month: 'March',
        year: '2025',
        hourTime: '10',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'q8',
        taglineText:
          'Get the best organic carrots at unbeatable prices - 10% off this week only',
        date: '02',
        month: 'March',
        year: '2025',
        hourTime: '10',
