  ...
  return (
    <SafeAreaView style={styles.safeAreaContainer}>
      ...
      >
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Specific Vendor Order Now', {details: vendor})} style={{width: 118, backgroundColor: "#76B117", height: 36, left: width * 0.68, borderRadius: 24, borderWidth: 1, padding: 8, borderColor: '#76B117', justifyContent: 'center', alignContent: 'center', alignItems: 'center'}}>
