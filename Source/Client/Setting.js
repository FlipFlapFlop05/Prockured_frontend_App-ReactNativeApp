...
export default function ClientSetting() {
  ...
  const menuItems = [
    { id: 1, icon: UserIcon, label: 'Edit Profile Details', screen: 'Client Profile' },
    { id: 2, icon: DocumentChartBarIcon, label: 'Teams & Roles', modal: 'teamsRoles' },
    { id: 3, icon: MapIcon, label: 'Multiple Outlet Dashboard', screen: 'Multiple Outlet Dashboard' },
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          <Image source={require('../Images/ProckuredImage.jpg')} style={styles.profileImage} />
