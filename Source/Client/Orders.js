        ...
        <View style={styles.orderItem}>
            <View style={styles.orderLeft}>
                ...
                <View>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Specific Order Screen')}>
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.filters}>
                <TouchableOpacity style={styles.filterBox} onPress={() => openModal('sort')}>
                    <Text style={styles.filterText}>Sort by</Text>
                    <ChevronDownIcon size={14} color="green" />
                </TouchableOpacity>

                <TouchableOpacity style={styles.filterBox} onPress={() => openModal('date')}>
                    <Text style={styles.filterText}>{selectedDate}</Text>
                    <ChevronDownIcon size={14} color="green" />
                </TouchableOpacity>

                <TouchableOpacity style={styles.filterBox} onPress={() => openModal('category')}>
            ...
            <View style={styles.tableHeader}>
                <View style={{backgroundColor: '#E9E9E9', width: 110, alignItems: 'center', height: 40, justifyContent: 'center', borderRadius: 20}}>
            ...
            <Modal
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalBox}>
                        ...
                        {modalType === 'sort' &&
                            ['Latest First', 'Oldest First', 'Value High to Low'].map(sort => (
